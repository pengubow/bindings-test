...
class DailyLevelPage : FLAlertLayer, FLAlertLayerProtocol, GJDailyLevelDelegate, LevelDownloadDelegate {
    ...
    callback void updateTimers(float) = win 0xd0360, imac 0x21f570, m1 0x1d24a8, ios 0x1bbe2c;
...
class EditLevelLayer : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol, UploadActionDelegate, UploadPopupDelegate, SetIDPopupDelegate {
    ...
    void onLevelInfo(cocos2d::CCObject* sender) = win 0xd5500, m1 0x1a2420, imac 0x1eb320, ios 0xee63c;
...
class EditorPauseLayer : CCBlockLayer, FLAlertLayerProtocol {
    ...
    void onSaveAndExit(cocos2d::CCObject* sender) = win 0xdcd20, imac 0x281980, m1 0x22b3c0, ios 0x396970;
...
class EditorUI : cocos2d::CCLayer, FLAlertLayerProtocol, ColorSelectDelegate, GJRotationControlDelegate, GJScaleControlDelegate, GJTransformControlDelegate, MusicDownloadDelegate, SetIDPopupDelegate {
    ...
    void onDeselectAll(cocos2d::CCObject* sender) = win 0x10fd40, m1 0x2c478, ios 0x3dda90;
...
class FriendRequestPopup : FLAlertLayer, UploadActionDelegate, UploadPopupDelegate, FLAlertLayerProtocol {
    ...
    void onClose(cocos2d::CCObject* sender) = win 0x28f440, m1 0x23a014, imac 0x291c80, ios 0x2d8e64;
...
class GameLevelManager : cocos2d::CCNode {
    ...
    void encodeDataTo(DS_Dictionary*) = win 0x148e00, imac 0x524e30, m1 0x480b48, ios 0x9e988;
    void firstSetup();
    void followUser(int);
    ...
    void getLevelLeaderboard(GJGameLevel*, LevelLeaderboardType, LevelLeaderboardMode) = win 0x155ff0, imac 0x535090, m1 0x48ed8c, ios 0xa6d94;
    ...
    void limitSavedLevels() = win 0x148090, imac 0x5236b0, m1 0x47f58c, ios 0x9d9e8;
    ...
    void onProcessHttpRequestCompleted(cocos2d::extension::CCHttpClient*, cocos2d::extension::CCHttpResponse*) = win 0x140d10, m1 0x464438, imac 0x504de0, ios 0x8be3c;
    ...
    void resetCommentTimersForLevelID(int, CommentKeyType) = win 0x15c770, imac 0x53c490, m1 0x495b6c, ios 0xab1bc;
...
class GameStatsManager : cocos2d::CCNode {
    ...
    int getBaseCurrencyForLevel(GJGameLevel*) = win 0x1dd4b0, imac 0x708c0, m1 0x642c4, ios 0x3325b8;
...
class GJFollowCommandLayer : SetupTriggerPopup {
    ...
    void updateTargetGroupID() = win 0x26ae80;
    void updateTargetGroupID2() = win 0x26af50;
    void updateTextInputLabel() = win 0x26ad60;
    void updateTextInputLabel2() = win 0x26adf0;
    void updateXMod() = win 0x26b020;
    void updateXModLabel() = win 0x26a650;
    void updateYMod() = win 0x26b0a0;
...
class GJRequestCell : TableViewCell, FLAlertLayerProtocol, UploadPopupDelegate, UploadActionDelegate {
    ...
    void markAsRead() = win 0xbbf50, m1 0x1f4594, imac 0x245960, ios 0x114de4; // inlined on macos
    void onDeleteRequest(cocos2d::CCObject* sender) = win 0xbc030, m1 0x1f4470, imac 0x245830;
    void onToggle(cocos2d::CCObject* sender);
    void onViewFriendRequest(cocos2d::CCObject* sender) = win 0xbbea0, m1 0x1f4398, imac 0x245740, ios 0x114c80;
    void onViewProfile(cocos2d::CCObject* sender);
...
class GJUserCell : TableViewCell, FLAlertLayerProtocol, UploadPopupDelegate, UploadActionDelegate {
    ...
    void onCancelFriendRequest(cocos2d::CCObject* sender) = win 0xbaa50;
    void onRemoveFriend(cocos2d::CCObject* sender) = win 0xbabf0, m1 0x1f3644, imac 0x2447c0;
    void onSendMessage(cocos2d::CCObject* sender) = win 0xbae30;
    void onUnblockUser(cocos2d::CCObject* sender) = win 0xba840, m1 0x1f3244, imac 0x2443f0, ios 0x114254;
    void onViewFriendRequest(cocos2d::CCObject* sender);
    void onViewProfile(cocos2d::CCObject* sender) = win 0xba800;
    void updateBGColor(int) = ios 0x10c4b0;
...
class InfoLayer : FLAlertLayer, LevelCommentDelegate, CommentUploadDelegate, FLAlertLayerProtocol {
    ...
    bool isCorrect(char const*);
    void loadPage(int, bool) = win 0x2b6c80, imac 0x79bd10, m1 0x6ae3e8, ios 0x3518ac;
    ...
    void onMore(cocos2d::CCObject* sender) = win 0x2b5e00, imac 0x79ae40, m1 0x6ad570, ios 0x350d94;
    ...
    void onRefreshComments(cocos2d::CCObject* sender) = win 0x2b5620, imac 0x79c870, m1 0x6aee78, ios 0x3521c4;
...
class LevelInfoLayer : cocos2d::CCLayer, LevelDownloadDelegate, LevelUpdateDelegate, RateLevelDelegate, LikeItemDelegate, FLAlertLayerProtocol, LevelDeleteDelegate, NumberInputDelegate, SetIDPopupDelegate, TableViewCellDelegate {
    ...
    void onViewProfile(cocos2d::CCObject* sender) = win 0x2ea460, imac 0x2abc20, m1 0x251b4c, ios 0x2a958;
    void playStep2();
...
class LevelLeaderboard : FLAlertLayer, LeaderboardManagerDelegate, FLAlertLayerProtocol {
    ...
    void onClose(cocos2d::CCObject* sender) = win 0x84620, m1 0x35146c, imac 0x3c87f0, ios 0x24f504;
    void onDeleteLocalScores(cocos2d::CCObject* sender) = imac 0x3c8720, m1 0x351394;
    void onUpdate(cocos2d::CCObject* sender) = win 0x2eddc0, m1 0x3514a8, imac 0x3c8820, ios 0x24f540;
...
class PlayerObject : GameObject, AnimatedSpriteDelegate {
    ...
    void playSpawnEffect() = win 0x381650, imac 0x401bb0, m1 0x37fe98, ios 0x227ff8;
...
class SetupCameraEdgePopup : SetupTriggerPopup {
    ...
    void onCameraEdge(cocos2d::CCObject* sender) = win 0x3fbe10, m1 0x4c624c, imac 0x571f20;
    void onTargetIDArrow(cocos2d::CCObject* sender) = win 0x3fbf70, m1 0x4c6094, imac 0x571d40;
    void onUnlockEdge(cocos2d::CCObject* sender) = win 0x3fbf40, m1 0x4c633c, imac 0x572050;
...
class SetupCountTriggerPopup : SetupTriggerPopup {
    ...
    void onEnableGroup(cocos2d::CCObject* sender) = win 0x401660;
    void onItemIDArrow(cocos2d::CCObject* sender) = win 0x4045c0, m1 0x24eba4, imac 0x2a87d0;
    void onMultiActivate(cocos2d::CCObject* sender) = win 0x4044f0;
    void onTargetCountArrow(cocos2d::CCObject* sender) = win 0x404580, m1 0x24ec4c, imac 0x2a8890;
    void onTargetIDArrow(cocos2d::CCObject* sender) = win 0x404610, m1 0x24ecdc, imac 0x2a8940;
...
class SetupInstantCountPopup : SetupTriggerPopup {
    ...
    void onEnableGroup(cocos2d::CCObject* sender) = win 0x401660;
    void onTargetCountArrow(cocos2d::CCObject* sender) = win 0x404580, m1 0x5055c8, imac 0x5d1780;
    void onTargetID2Arrow(cocos2d::CCObject* sender) = win 0x40b700, m1 0x505658, imac 0x5d16c0;
    void onTargetIDArrow(cocos2d::CCObject* sender) = win 0x4045c0, m1 0x505520, imac 0x5d1830;
    void updateCountTextInputLabel() = win 0x401eb0;
    void updateItemID() = win 0x401f30;
    void updateItemIDInputLabel() = win 0x4048d0;
    void updateTargetCount() = win 0x404aa0;
...
class SongInfoObject : cocos2d::CCNode {
    ...
    bool init(int songID, gd::string songName, gd::string artistName, int artistID, float filesize, gd::string youtubeVideo, gd::string youtubeChannel, gd::string url, int nongType, gd::string extraArtistIDs, bool isNew, int newType, int priority) = win 0x3302f0;
...
class UILayer : cocos2d::CCLayerColor {
    ...
    void onCheck(cocos2d::CCObject* sender) = win 0x4b54d0, imac 0x4b5230, m1 0x41d3e8, ios 0x4d1b0;
